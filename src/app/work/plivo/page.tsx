...
import { PlivoFlow } from "@/components/case-study/PlivoFlow";
import {
  Shot,
  Pair,
  Triptych,
...
export default function PlivoCaseStudy() {
  return (
    ...
    >
      ...
      <PlivoFlow caption="Campaign lifecycle, brand registration through outcome and recovery. Dark nodes (5, 6a, 6b) are the additions that removed the FDE → support → messaging-team cascade. Hover or tap any node to focus it." />
